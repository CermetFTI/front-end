        ...
        <div style={{height:"100vh",overflow:"hidden", position:"absolute",top:"0",width:"100vw", left:"0px"}}>
            ...
            <Container className="d-flex align-items-center" style={{height:"100%"}}>
                    <div style={{color:"white",position:"relative",zIndex:"10", margin:"0 auto"}}>
                        ...
                        <hr color="white"/>
                        <p>
                        <p style={{maxWidth:"50vw",textAlign:"center"}}>Halooo sobat ambis! Cermet adalah program kerja divisi student development BPA FTI 2020, di website ini terdapat berbagai info mengenai lomba, internship, dan beasiswa</p></p>
